...
int main() {
    ...
    auto shader = LearnOpenGLFramework::Shader("light_map_vertexShader", "light_map_fragmentShader");
    shader.use();
    ...
    auto textureHelper = LearnOpenGLFramework::TextureHelper();
    auto diffuseMap = textureHelper.createTexture("E:\\CLionProjects\\learnopengl\\images\\container2.jpg", GL_TEXTURE0);
    auto specularMap = textureHelper.createTexture("E:\\CLionProjects\\learnopengl\\images\\container2_specular.jpg", GL_TEXTURE1);
    auto emissionMap = textureHelper.createTexture("E:\\CLionProjects\\learnopengl\\images\\matrix.jpg", GL_TEXTURE2);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shader.setUniformVec3("lightPos", lightPos.x, lightPos.y, lightPos.z);
...
//
//        shader.setUniformVec3("light.ambient", ambientColor.x, ambientColor.y, ambientColor.z);
//        shader.setUniformVec3("light.diffuse", diffuseColor.x, diffuseColor.y, diffuseColor.z);
